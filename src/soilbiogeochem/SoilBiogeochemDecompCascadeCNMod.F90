...
contains
  ...
  subroutine init_decompcascade_cn(bounds, soilbiogeochem_state_inst)
    ...
    associate(                                                                                        &
      ...
      docf_l1s1=0.00_r8    !params_inst%docf_l1s1_cn
      docf_l2s2=0.00_r8  !params_inst%docf_l2s2_cn
      docf_l3s3=params_inst%docf_l3s3_cn
      docf_s1s2=0.00_r8    !params_inst%docf_s1s2_cn
      docf_s2s3=0.00_r8  !params_inst%docf_s2s3_cn
